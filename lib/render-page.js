...
export const LAYOUTS = {
  ...
  "landing-v1": {
    label: "Landing v1",
    description: "Centered hero, services grid, testimonials, CTA. A general marketing page.",
    sections: [
  ...
  "landing-v2": {
    label: "Landing v2",
    description: "Split hero, process steps, service list, FAQ, contact CTA. Great for service pages.",
    sections: [
      { type: "hero",         variant: "split",      content: def("hero", "split") },
      { type: "steps",        variant: "horizontal", content: def("steps", "horizontal") },
  ...
  "landing-v3": {
    label: "Landing v3",
    description: "Minimal hero, founder story, gallery, single quote, inline CTA. Editorial feel.",
    sections: [
