  ...
  hero: {
    ...
    variants: [
      { id: "centered", label: "Centered", description: "Big centered title with a CTA button.",
        preview: `<div class="wf-section" style="text-align:center;padding:14px 10px;">
          <div class="wf-eyebrow wf-center"></div>
          <div class="wf-title wf-title--lg wf-center" style="width:70%"></div>
          <div class="wf-text wf-center" style="width:55%"></div>
          <div class="wf-text wf-center" style="width:40%"></div>
          <div class="wf-btn wf-center" style="margin-top:4px"></div>
        </div>`,
      ...
      { id: "split", label: "Split", description: "Text on the left, image on the right.",
        preview: `<div class="wf-section wf-row">
          <div class="wf-col">
            ...
            <div class="wf-title wf-title--lg"></div>
            <div class="wf-text"></div>
            <div class="wf-text wf-text--short"></div>
            <div class="wf-btn" style="margin-top:4px"></div>
          </div>
      ...
      { id: "minimal", label: "Minimal", description: "Small eyebrow + title, nothing else.",
        preview: `<div class="wf-section" style="text-align:center;padding:22px 10px;">
          <div class="wf-eyebrow wf-center"></div>
          <div class="wf-title wf-title--lg wf-center" style="width:60%"></div>
  ...
  about: {
    ...
    variants: [
      ...
      { id: "founder", label: "Founder card", description: "Portrait, bio, and a credentials list.",
        preview: `<div class="wf-section wf-row">
          <div class="wf-col" style="flex:0 0 34%"><div class="wf-image wf-image--tall"></div></div>
          <div class="wf-col">
            <div class="wf-eyebrow"></div>
            <div class="wf-title"></div>
            <div class="wf-text"></div>
      ...
      { id: "stats", label: "Intro + stats", description: "Short intro followed by a row of stats.",
        preview: `<div class="wf-section" style="text-align:center;">
          <div class="wf-eyebrow wf-center"></div>
          <div class="wf-title wf-center" style="width:60%"></div>
          <div class="wf-text wf-center" style="width:75%"></div>
          <div class="wf-grid-3" style="margin-top:6px">
            <div class="wf-stat"><div class="wf-stat__num"></div><div class="wf-text wf-center" style="width:75%;margin-top:3px"></div></div>
            <div class="wf-stat"><div class="wf-stat__num"></div><div class="wf-text wf-center" style="width:75%;margin-top:3px"></div></div>
            <div class="wf-stat"><div class="wf-stat__num"></div><div class="wf-text wf-center" style="width:75%;margin-top:3px"></div></div>
          </div>
        </div>`,
  ...
  services: {
    ...
    variants: [
      { id: "grid", label: "Card grid", description: "Three service cards with images.",
        preview: `<div class="wf-section" style="text-align:center;">
          <div class="wf-title wf-center" style="width:55%"></div>
          <div class="wf-grid-3" style="margin-top:6px">
            <div class="wf-card"><div class="wf-image"></div><div class="wf-text" style="width:65%;margin:4px auto 0"></div></div>
            <div class="wf-card"><div class="wf-image"></div><div class="wf-text" style="width:65%;margin:4px auto 0"></div></div>
            <div class="wf-card"><div class="wf-image"></div><div class="wf-text" style="width:65%;margin:4px auto 0"></div></div>
          </div>
        </div>`,
      ...
      { id: "list", label: "Long list", description: "Row-per-service, quiet and text-forward.",
        preview: `<div class="wf-section">
          <div class="wf-title" style="width:35%"></div>
          <div style="margin-top:4px">
            <div class="wf-list-row"><div class="wf-row-title"></div><div class="wf-btn" style="width:16%;height:6px"></div></div>
            <div class="wf-list-row"><div class="wf-row-title"></div><div class="wf-btn" style="width:16%;height:6px"></div></div>
            <div class="wf-list-row"><div class="wf-row-title"></div><div class="wf-btn" style="width:16%;height:6px"></div></div>
            <div class="wf-list-row"><div class="wf-row-title"></div><div class="wf-btn" style="width:16%;height:6px"></div></div>
          </div>
      ...
      { id: "features", label: "Feature comparison", description: "Three feature columns with bullet points.",
        preview: `<div class="wf-section" style="text-align:center;">
          <div class="wf-title wf-center" style="width:50%"></div>
          <div class="wf-grid-3" style="margin-top:6px;text-align:left">
            <div class="wf-card"><div class="wf-title" style="width:70%;height:5px"></div><div class="wf-bullet"></div><div class="wf-bullet"></div><div class="wf-bullet"></div></div>
            <div class="wf-card"><div class="wf-title" style="width:70%;height:5px"></div><div class="wf-bullet"></div><div class="wf-bullet"></div><div class="wf-bullet"></div></div>
            <div class="wf-card"><div class="wf-title" style="width:70%;height:5px"></div><div class="wf-bullet"></div><div class="wf-bullet"></div><div class="wf-bullet"></div></div>
          </div>
        </div>`,
  ...
  faq: {
    ...
    variants: [
      { id: "accordion", label: "Accordion", description: "Click-to-expand questions.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:50%"></div>
          <div class="wf-stack" style="margin-top:6px;text-align:left">
            <div class="wf-acc"></div><div class="wf-acc"></div><div class="wf-acc"></div><div class="wf-acc"></div><div class="wf-acc"></div>
          </div>
        </div>`,
      ...
      { id: "two-col", label: "Two-column grid", description: "Grid of Q&A pairs.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:40%"></div>
          <div class="wf-grid-2" style="margin-top:8px;text-align:left">
            <div><div class="wf-title" style="width:60%;height:5px"></div><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div><div class="wf-title" style="width:60%;height:5px"></div><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div><div class="wf-title" style="width:60%;height:5px"></div><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div><div class="wf-title" style="width:60%;height:5px"></div><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
          </div>
      ...
      { id: "cards", label: "Compact cards", description: "Small card grid, six questions.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:45%"></div>
          <div class="wf-grid-3" style="margin-top:6px">
            <div class="wf-card"><div class="wf-q">?</div><div class="wf-text" style="width:75%"></div></div>
            <div class="wf-card"><div class="wf-q">?</div><div class="wf-text" style="width:75%"></div></div>
            <div class="wf-card"><div class="wf-q">?</div><div class="wf-text" style="width:75%"></div></div>
            <div class="wf-card"><div class="wf-q">?</div><div class="wf-text" style="width:75%"></div></div>
            <div class="wf-card"><div class="wf-q">?</div><div class="wf-text" style="width:75%"></div></div>
  ...
  cta: {
    ...
    variants: [
      { id: "dark", label: "Full-width banner", description: "Dark background, centered CTA.",
        preview: `<div class="wf-section wf-section--dark" style="text-align:center">
          <div class="wf-eyebrow wf-center"></div>
          <div class="wf-title wf-title--lg wf-center" style="width:70%"></div>
          <div class="wf-text wf-center" style="width:55%"></div>
          <div class="wf-btn wf-center wf-btn--white" style="margin-top:4px"></div>
        </div>`,
      ...
      { id: "split", label: "Text + form", description: "Copy on the left, contact form on the right.",
        preview: `<div class="wf-section wf-row">
          ...
          <div class="wf-col">
            <div class="wf-card">
              <div class="wf-title" style="width:55%;height:5px"></div>
              <div class="wf-input"></div>
              <div class="wf-input"></div>
              <div class="wf-btn" style="width:100%;margin-top:4px"></div>
            </div>
          </div>
        </div>`,
      ...
      { id: "pill", label: "Pill", description: "Small inline callout with a button.",
        preview: `<div class="wf-section" style="padding:14px 10px">
          <div class="wf-pill">
            <div class="wf-title" style="width:45%;height:5px"></div>
            <div class="wf-btn" style="width:22%;height:10px"></div>
          </div>
        </div>`,
    ...
    variants: [
      { id: "vertical", label: "Numbered vertical", description: "1-2-3 stacked, each with a description.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:45%"></div>
          <div class="wf-stack" style="margin-top:6px;text-align:left">
            <div class="wf-step"><div class="wf-step__num">1</div><div class="wf-col" style="gap:3px"><div class="wf-title" style="width:40%;height:5px"></div><div class="wf-text wf-text--short"></div></div></div>
            <div class="wf-step"><div class="wf-step__num">2</div><div class="wf-col" style="gap:3px"><div class="wf-title" style="width:40%;height:5px"></div><div class="wf-text wf-text--short"></div></div></div>
            <div class="wf-step"><div class="wf-step__num">3</div><div class="wf-col" style="gap:3px"><div class="wf-title" style="width:40%;height:5px"></div><div class="wf-text wf-text--short"></div></div></div>
          </div>
        </div>`,
      ...
      { id: "horizontal", label: "Horizontal row", description: "Three columns side-by-side.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:45%"></div>
          <div class="wf-grid-3" style="margin-top:6px">
            <div><div class="wf-num--big wf-center"></div><div class="wf-title wf-center" style="width:60%;height:5px;margin-top:4px"></div><div class="wf-text wf-center" style="width:80%"></div></div>
            <div><div class="wf-num--big wf-center"></div><div class="wf-title wf-center" style="width:60%;height:5px;margin-top:4px"></div><div class="wf-text wf-center" style="width:80%"></div></div>
            <div><div class="wf-num--big wf-center"></div><div class="wf-title wf-center" style="width:60%;height:5px;margin-top:4px"></div><div class="wf-text wf-center" style="width:80%"></div></div>
          </div>
        </div>`,
      ...
      { id: "timeline", label: "Timeline", description: "Dots connected by a line.",
        preview: `<div class="wf-section" style="text-align:center">
          ...
          <div class="wf-timeline">
            <div class="wf-tl-item"><div class="wf-tl-dot"></div><div class="wf-text wf-center" style="width:70%;margin-top:4px"></div></div>
            <div class="wf-tl-item"><div class="wf-tl-dot"></div><div class="wf-text wf-center" style="width:70%;margin-top:4px"></div></div>
            <div class="wf-tl-item"><div class="wf-tl-dot"></div><div class="wf-text wf-center" style="width:70%;margin-top:4px"></div></div>
            <div class="wf-tl-item"><div class="wf-tl-dot"></div><div class="wf-text wf-center" style="width:70%;margin-top:4px"></div></div>
          </div>
  ...
  testimonial: {
    ...
    variants: [
      { id: "quote", label: "Single big quote", description: "One large centered quote.",
        preview: `<div class="wf-section" style="text-align:center;padding:16px 10px">
          <div class="wf-quote-mark wf-center">"</div>
          <div class="wf-text wf-center" style="width:80%;height:5px"></div>
          <div class="wf-text wf-center" style="width:65%;height:5px"></div>
          <div class="wf-text wf-center" style="width:30%;margin-top:6px"></div>
        </div>`,
      ...
      { id: "cards", label: "Three cards", description: "Three testimonial cards with ratings.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:45%"></div>
          <div class="wf-grid-3" style="margin-top:6px;text-align:left">
            <div class="wf-card"><div class="wf-stars"></div><div class="wf-text"></div><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div class="wf-card"><div class="wf-stars"></div><div class="wf-text"></div><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div class="wf-card"><div class="wf-stars"></div><div class="wf-text"></div><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
          </div>
        </div>`,
      ...
      { id: "row", label: "Quote wall", description: "A row of shorter quotes.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:45%"></div>
          <div class="wf-grid-3" style="margin-top:6px;text-align:left;grid-template-columns:repeat(4,1fr)">
            <div class="wf-quote-block"><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div class="wf-quote-block"><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div class="wf-quote-block"><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
            <div class="wf-quote-block"><div class="wf-text"></div><div class="wf-text wf-text--short"></div></div>
          </div>
  ...
  gallery: {
    ...
    variants: [
      { id: "grid", label: "3-column grid", description: "Six equal-sized square images.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:35%"></div>
          <div class="wf-grid-3" style="margin-top:6px">
      ...
      { id: "masonry", label: "Masonry", description: "Mixed heights, columns layout.",
        preview: `<div class="wf-section" style="text-align:center">
          <div class="wf-title wf-center" style="width:35%"></div>
          <div class="wf-masonry" style="margin-top:6px">
            <div class="wf-image"></div><div class="wf-image wf-image--tall"></div><div class="wf-image"></div>
            <div class="wf-image wf-image--tall"></div><div class="wf-image"></div><div class="wf-image"></div>
          </div>
        </div>`,
      ...
      { id: "band", label: "Photo band", description: "Full-width thin row of photos.",
        preview: `<div class="wf-section" style="padding:0">
          <div class="wf-band">
            <div class="wf-image" style="border-radius:0"></div><div class="wf-image" style="border-radius:0"></div><div class="wf-image" style="border-radius:0"></div><div class="wf-image" style="border-radius:0"></div>
          </div>
        </div>`,
...
// Same 5-section skeleton — hero → about → services → testimonial → CTA
// — with a different variant of each in v1 / v2 / v3.
export const LAYOUTS = {
  "landing-v1": {
    label: "Landing v1",
    description: "Centered hero, stats intro, service card grid, three testimonials, dark CTA.",
    sections: [
  ...
  "landing-v2": {
    label: "Landing v2",
    description: "Split hero, two-column about, service list, quote wall, split contact CTA.",
    sections: [
  ...
  "landing-v3": {
    label: "Landing v3",
    description: "Minimal hero, founder card, three-column features, single big quote, inline pill CTA.",
    sections: [
