...
export async function ensureSchema() {
  ...
  // the Neon 402 outage (2026-08-04 → 2026-08-06). Emails were delivered
  ...
  // email body. Idempotent guard: skips insert if a row with the same
  // email + source already exists, so this stays safe across cold
  // starts.
  const MISSED_LEADS = [
    { name: "Daniel",         email: "Fisherdaniel46@gmail.com",       service: "Men's Issues",               created_at: "2026-08-04 16:00:00+00" },
    { name: "Loveleen Kaur",  email: "loveleenchawla2018@gmail.com",   service: "Free Virtual Consultation",  created_at: "2026-08-05 16:00:00+00" },
    { name: "Doug",           email: "dsimpson1661@gmail.com",         service: "Free Virtual Consultation",  created_at: "2026-08-06 16:00:00+00" },
  ];
  for (const l of MISSED_LEADS) {
    try {
      ...
      // Non-fatal — never let a backfill quirk break the whole schema ensure.
